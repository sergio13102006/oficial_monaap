...
def login_view(request):
    ...
    form_errors.extend(form.errors.get("username", []))
    form_errors.extend(form.errors.get("password", []))
    login_message = str(form_errors[0]) if form_errors else "Credenciales inválidas."
