#!/usr/bin/env python
"""
Script utilitario para crear backups de prueba y validar su funcionamiento.
Se mantiene dentro del paquete tests para centralizar las herramientas de validación.
"""
import os
import django
...
def main():
    ...
    try:
        ...
        try:
            ...
            print(
                f"     - Archivo existe: {'SI' if backup_completo.archivo_existe else 'NO'}"
            )
        except Exception as e:
            print(f"   Error: {str(e)}")
        ...
        for i, b in enumerate(backups, 1):
            ...
            print(
                f"   - Usuario: {b.usuario.username if b.usuario else 'Sistema'} | Archivo: {archivo_str}"
            )
            print()
