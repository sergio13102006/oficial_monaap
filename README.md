...
4. **Configura variables de entorno:**
   ...
   - `EMAIL_HOST_USER` y `EMAIL_HOST_PASSWORD`: Solo si vas a enviar correos reales con Gmail en producción
...
- Configura `EMAIL_HOST_USER` y `EMAIL_HOST_PASSWORD` si vas a usar Gmail SMTP
